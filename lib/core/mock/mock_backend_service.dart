...
class MockBackendService {
  ...
  VlessConfig fetchVlessConfig(String locationCode) {
    enable();
    final normalized = locationCode.trim().isEmpty ? 'auto-fastest' : locationCode.trim();
    return VlessConfig(
      locationCode: normalized,
      server: normalized == 'fi-1' ? 'fi1.inet.example' : normalized == 'de-1' ? 'de1.inet.example' : 'auto.inet.example',
      port: 443,
      ...
      transport: 'tcp',
      security: 'reality',
      sni: 'edge.inet.example',
      publicKey: 'PUBLIC_KEY_PLACEHOLDER',
      shortId: 'abcd1234',
      fingerprint: 'chrome',
      dnsServers: const ['1.1.1.1', '8.8.8.8'],
      domainResolver: 'dns-remote',
      packetEncoding: 'xudp',
    );
  }
