...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      ref.read(vpnControllerProvider).refreshStatus();
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  PrimaryButton(
                    ...
                    onPressed: vpnController.status == VpnConnectionStatus.connecting ||
                            vpnController.status == VpnConnectionStatus.disconnecting
                        ? null
                        : () => _toggleConnection(
                              context,
                  ...
                  if (vpnController.reconnectOnLaunch && vpnController.lastLocationCode != null) ...[
                    const SizedBox(height: 12),
                    Text(
                      'Автопереподключение: ${vpnController.lastLocationCode}',
