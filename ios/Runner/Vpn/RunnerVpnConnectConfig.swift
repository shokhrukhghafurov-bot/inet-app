...
struct RunnerVpnConnectConfig {
  init?(_ raw: [String: Any]) {
    ...
    self.engine = (raw["engine"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines).isEmpty == false ? (raw["engine"] as? String)! : "sing-box"
    ...
    self.domainResolver = raw["domainResolver"] as? String
    self.packetEncoding = raw["packetEncoding"] as? String
    self.rawSingBoxConfig = raw["rawSingBoxConfig"] as? String
    self.rawXrayConfig = raw["rawXrayConfig"] as? String
  }
